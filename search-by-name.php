...
if(isset($_POST["customer_name"])) {
    $keyword = $_POST['customer_name'];
    $connection = new mysqli($DB_HOST, $DB_USER, $DB_PASSWORD, $DB_NAME);
    if($connection->connect_error) {
        die("Connection failed:" . $connection->connect_error);
    }

    $query = "SELECT id, name, email_address, location, contact_number, since, GST_NO from customer where name='" . $keyword ."'";
...
<head>
  ...
  <title>Search Customers by Name <?php echo $TITLE; ?></title>
                        ...
                        <div class="card-header py-3">
                            <form class="search" method="post">          
                              <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="customer_name" aria-describedby="emailHelp" placeholder="Search by Customer Name">
                              </div>
